 ...
 * 
 * (c) Rafal Zajac <rzajac@gmail.com> http://github.com/rzajac/angularjs-slider
 * 
 * Version: v2.1.0
 * 
    ...
    (
        ...
        function(angular) {
          ...
          .factory('RzSliderOptions', function() {
            ...
            var factory = {};
            /**
             * `options({})` allows global configuration of all
             * sliders in the application.
             * 
             * var app = angular.module( 'App', ['rzModule'],
             * function( RzSliderOptions ) { // show ticks for all
             * sliders RzSliderOptions.options( { showTicks: true } );
             * });
             */
                ...
                [
                    ...
                    function($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle) {
                      ...
                      var Slider = function(scope, sliderElem) {
                        ...
                        /**
                         * property that handle position
                         * (defaults to left for
                         * horizontal)
                         * 
                         * @type {string}
                         */
                        ...
                        /**
                         * property that handle
                         * dimension (defaults to width
                         * for horizontal)
                         * 
                         * @type {string}
                         */
                        ...
                        /**
                         * Half of the width or height
                         * of the slider handles
                         * 
                         * @type {number}
                         */
                        ...
                        // Slider DOM elements wrapped
                        // in jqLite
                        this.fullBar = null; // The
                        // whole
                        // slider
                        // bar
                        this.selBar = null; // Highlight
                        // between
                        // two
                        // handles
                        this.minH = null; // Left
                        // slider
                        // handle
                        this.maxH = null; // Right
                        // slider
                        // handle
                        this.flrLab = null; // Floor
                        // label
                        this.ceilLab = null; // Ceiling
                        // label
                        this.minLab = null; // Label
                        // above the
                        // low value
                        this.maxLab = null; // Label
                        // above the
                        // high
                        // value
                        this.cmbLab = null; // Combined
                        // label
                      ...
                      Slider.prototype = {
                         ...
                         */
                        init : function() {
                          var thrLow, thrHigh, calcDimFn = angular.bind(this, this.calcViewDimensions), self = this;
                          ...
                          // Recalculate slider view
                          // dimensions
                          this.scope.$on('reCalcViewDimensions', calcDimFn);

                          // Recalculate stuff if view
                          // port dimensions have
                          // changed
                        ...
                        /**
                         * Read the user options and
                         * apply them to the slider
                         * model
                         */
                        ...
                        /**
                         * Manage the events bindings
                         * based on readOnly and
                         * disabled options
                         * 
                         * @returns {undefined}
                         */
                         ...
                         * 
                         * Run only once during
                         * initialization and every time
                         * view port changes size
                         * 
                         * @returns {undefined}
                         */
                        initHandles : function() {
                           ...
                           * updated after the high
                           * handle but before the
                           * combined label
                           */
                          if (this.range)
                        ...
                        translateFn : function(value, label, useCustomTr) {
                          ...
                          var valStr = String((useCustomTr ? this.customTrFn(value, this.options.id) : value)), getDimension = false;
                          ...
                          // Update width only when
                          // length of the label have
                          // changed
                          if (getDimension) {
                         ...
                         * values for the slider and
                         * ensure the model and high
                        ...
                        updateTicksScale : function() {
                          ...
                          var positions = '', ticksCount = Math.round((this.maxValue - this.minValue) / this.step) + 1;
                        ...
                        /**
                         * Update slider selection bar,
                         * combined label and range
                         * label
                         * 
                         * @returns {undefined}
                         */
                        ...
                        updateCmbLabel : function() {
                          ...
                          if (this.minLab.rzsp + this.minLab.rzsd + 10 >= this.maxLab.rzsp) {
                            ...
                            var pos = Math.min(Math.max((this.selBar.rzsp + this.selBar.rzsd / 2 - this.cmbLab.rzsd / 2), 0),
                         ...
                         * if a translate function is
                         * provided else the original
                         * value
                         * 
                         * @param value
                         * @returns {*}
                        ...
                        roundStep : function(value) {
                          var step = this.step, remainder = +((value - this.minValue) % step).toFixed(3), steppedValue = remainder > (step / 2) ? value
                              + step - remainder : value - remainder;
                        ...
                        /**
                         * Set element left/top offset
                         * depending on whether slider
                         ...
                         * rendered is within the slider
                         * bounds, even if the value is
                         * not
                         * 
                         * @param {number}
                         *            val
                        ...
                        /**
                         * Get the X-coordinate or
                         * Y-coordinate of an event
                         * 
                         * @param {Object}
                         *            event The event
                         * @returns {number}
                        ...
                        /**
                         * Get the handle closest to an
                         * event.
                         * 
                         * @param event
                         *            {Event} The event
                         * @returns {jqLite} The handle
                         *          closest to the
                         *          event.
                         */
                        ...
                        onStart : function(pointer, ref, event) {
                          ...
                          // case the HTML where the
                          // sliders are on
                          // have been animated into
                          // view.
                          this.calcViewDimensions();
                        ...
                        onMove : function(pointer, event) {
                          var newOffset = this.getEventPosition(event), newValue;
                        ...
                        onDragMove : function(pointer, event) {
                          var newOffset = this.getEventPosition(event), newMinOffset, newMaxOffset, newMinValue, newMaxValue;
                        ...
                        /**
                         * Get event names for move and
                         * event end
                         * 
                         * @param {Event}
                         *            event The event
                         * 
                         * @return {{moveEvent: string,
                         *         endEvent: string}}
                         */
           ...
           * @name jqLite
           * 
           * @property {number|undefined} rzsp rzslider label position
           *           offset
           * @property {number|undefined} rzsd rzslider element
           *           dimension
           * @property {string|undefined} rzsv rzslider label
           *           value/text
